...
export default function CompareDetail() {
  ...
  return (
    <>
      <Row>
        <h1 className="compare-title">比較麻將桌機型</h1>
      </Row>
      <Row>
        <p className="compare-little-text">機型比較讓你一目了然免煩惱</p>
      </Row>
      <hr className="compare-line"></hr>
      <div className="compare-outside">
        <Row>
          <Col className="compare-space">
            <Select
          ...
          <Col className="compare-space" id="selectthree">
            <Select
              className="compare-select"
              id="selectOne"
